package com.example.testingsqldelight.ui.theme
...
fun PersonListScreen(
    ...
    val persons = viewModel.persons.collectAsState(initial = emptyList()).value
    ...
    Box(
        ...
        Column(
            ...
            Row(
                ...
                Spacer(modifier = Modifier.width(10.dp))
                IconButton(onClick = viewModel::onInserPersonClick) {
                    Icon(
